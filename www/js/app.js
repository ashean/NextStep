...
.controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
  ...
  $scope.projectsList = $firebase(new Firebase("https://nextstep.firebaseio.com/projects"));
  $scope.user = $firebase(new Firebase("https://nextstep.firebaseio.com/Users/John"));
